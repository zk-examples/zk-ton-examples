...
export class Verifier implements Contract {
    ...
    buildVerifyBody(opts: { pi_a: Buffer; pi_b: Buffer; pi_c: Buffer; pubInputs: bigint[] }) {
    ...
    async getVerifyMultiplierVerifier(
        provider: ContractProvider,
        opts: {
            pi_a: Buffer;
            pi_b: Buffer;
        ...
        const result = await provider.get('verify_MultiplierVerifier', args.build());
        return result.stack.readBoolean();
    }

    async getVerifyArkVerifier(
        provider: ContractProvider,
        opts: {
            pi_a: Buffer;
            pi_b: Buffer;
        ...
        const result = await provider.get('verify_ArkVerifier', args.build());
        return result.stack.readBoolean();
    }

    async getVerifyCubic(
        provider: ContractProvider,
        opts: {
            pi_a: Buffer;
            pi_b: Buffer;
        ...
        const result = await provider.get('verify_Cubic', args.build());
        return result.stack.readBoolean();
    }
}
